...
public class MemberDAO {
	...
	public int insertMember(MemberDTO dto) throws SQLException {
		...
		try {
			...
			sql = "INSERT INTO member1(userId, userPwd, userName, enabled, created_date, modify_date) VALUES (?, ?, ?, 1, SYSDATE, SYSDATE)";
    ...
    sb.append(" INTO member1(userId, userPwd, userName, enabled, created_date, modify_date) VALUES(?, ?, ?, 1, SYSDATE, SYSDATE) ");
    sb.append(" INTO member2(userId, birth, email, tel, zip, addr1, addr2) VALUES (?, TO_DATE(?,'YYYYMMDD'), ?, ?, ?, ?, ?) ");
