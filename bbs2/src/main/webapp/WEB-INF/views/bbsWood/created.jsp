...
$(function() {
	$("form #submitBtn").click(function() {
		let b = true;
		$("#boardForm :input").not("button").each(function() {
			if(! $(this).val().trim()) {
				b = false;
		...
		if(b) $("#boardForm").attr("action","${pageContext.request.contextPath}/bbsWood/${mode}_ok.do").submit();
